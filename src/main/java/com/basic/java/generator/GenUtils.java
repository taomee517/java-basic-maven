...
import com.basic.java.util.PRException;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.fzk" : mainPath;
        //封装模板数据
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new PRException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new PRException("获取配置文件失败，", e);
        }
    }
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("Entity.java.vm" )) {
            return packagePath + "po" + File.separator + className + "Entity.java";
        }
